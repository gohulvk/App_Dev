...
const FAQ = () => {
  ...
  const faqData = [
    ...
    { question: 'Do you offer international shipping?', answer: 'Yes, we provide international shipping services to over 200 countries. Please contact our customer service for specific details and pricing for your destination.' },
